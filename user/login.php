        ...
        <div class="container">
            <div class="temp-padd">
                ...
                <form class="form-group" action="includes/login.inc.php" method="POST">
                    ...
                    <button class="btn btn-success mb-2" style="background-color: #07a5e3" type="submit" name="login-submit">Login</button><br>
                    <a href="http://localhost/Tender/Contract/admin/index.php">Admin login?<a><br>
                </form>
