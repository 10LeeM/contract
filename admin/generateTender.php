...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800 text-uppercase">GENERATE CONTRACT</h1>

    <div class="row">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary text-center">Contract Details</h6>
            </div>
            <?php
            if (isset($_GET["error"])) {
            ...
            <div class="card-body">
                <form class="form-horizontal" action="insertInTable.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label class="control-label col-sm-2" for="TenderNo">Contract No.</label>
                        <div class="col-sm-10">
